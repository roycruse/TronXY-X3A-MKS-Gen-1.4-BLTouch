...
#define STRING_CONFIG_H_AUTHOR "Roy Cruse" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "TronXY X3A MKS BLTouch"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //TronXY Standard Bed with fibre under insulation sheet and 3mm glass bed with buildtak
  #define  DEFAULT_bedKp 549.59
  #define  DEFAULT_bedKi 104.82
  #define  DEFAULT_bedKd 720.37
...
//#define MANUAL_X_HOME_POS 0 // The X3A has a standard X offset (17mm) between the left endstop and bed left bed edge
//#define MANUAL_Y_HOME_POS 0 // The X3A has a standard Y offset (25mm) between the y endstop and the front bet edge

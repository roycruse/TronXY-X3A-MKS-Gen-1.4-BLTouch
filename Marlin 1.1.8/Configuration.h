 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 20, 80 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.28   // Z offset: -below +above  [the nozzle] [reducing this number effectivey lowers nozzle closer to bed at any given z height]
